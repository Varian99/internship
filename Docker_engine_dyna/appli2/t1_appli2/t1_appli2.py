...
from config_app import appli2_port, appli2_mqtt
...
def on_message(client, userdata, msg):
    ...
    client.publish("app1/sender", payload=encrypted_data, qos=0)

client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION2)
client.on_connect = on_connect
client.on_message = on_message
client.connect(appli2_mqtt, appli2_port)
client.loop_forever()